...
ri=pygame.image.load('E:/v_project/python/Race/R.jpg')
ri=pygame.transform.scale(ri,(1500,100))
def r(x,y):
	w.blit(ri,(x,y))

#crash image
c_image=pygame.image.load(r'E:/v_project/python/Race/c.png')
...
back_image=pygame.image.load(r'E:/v_project/python/Race/back.png')
bx=300
by=-50
def i(x,y):
...
#player
p_image=pygame.image.load(r'E:/v_project/python/Race/car.png')
...
#obstacle
o_image=pygame.image.load(r'E:/v_project/python/Race/barricade_2.png')
...
h=pygame.image.load(r'E:/v_project/python/Race/hpr.png')
...
#font medium
font2=pygame.font.Font(r'E:/v_project/python/Race/kenvector_future_thin.ttf',30)
def screen_text2(text,color,x ,y):
	screen_text2=font2.render(text,True,color)
	w.blit(screen_text2,(x,y))

font3=pygame.font.Font(r'E:/v_project/python/Race/kenvector_future_thin.ttf',25)
...
def crash():
	with open(r'E:/v_project/python/Race/untitled2.txt','r') as f:
		hiscore=f.read()
	w.fill((255,255,255))
...
def home1():
	exit_game=False
	pygame.mixer.init()
	pygame.mixer.music.load(r'E:/v_project/python/Race/bm1.mp3')
...
def home2():
	exit_game=False
	pygame.mixer.music.load(r'E:/v_project/python/Race/sad.mp3')
	pygame.mixer.music.play(-1)
	while not exit_game:
		w.fill((0,255,0))
		i(bx,by)
...
def game_loop():
	...
	pygame.mixer.music.load(r'E:/v_project/python/Race/bm.mp3')
	pygame.mixer.music.play(-1)
	with open(r'E:/v_project/python/Race/untitled2.txt','r') as f:
		hiscore=f.read()
...
#tracks
			...
			if math.sqrt(math.pow(p_x-ox1,2)+math.pow(p_y-oy1,2)) <=80 or math.sqrt(math.pow(p_x-ox2,2)+math.pow(p_y-oy2,2)) <=80:
				pygame.mixer.music.load(r'E:/v_project/python/Race/crash.mp3')
				pygame.mixer.music.play()
				game_over=True
